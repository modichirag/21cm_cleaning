...
from cosmo4d.lab import report, dg, objectives_dev
...
objfunc = getattr(objectives_dev, cfg['mods']['objective'])
...
ofolder = '/global/cscratch1/sd/chmodi/m3127/21cm_cleaning/recon/bias/wedge_kmin%.2f_ang%.1f/L%04d-N%04d-T%02d-B%01d/'%(kmin, angle, bs, nc, nsteps, B)
...
if rsdpos: 
    with open('/global/cscratch1/sd/chmodi/m3127/H1mass/highres/2560-9100-fixed/fastpm_%0.4f/Header/attr-v2'%aa) as ff:
        for line in ff.readlines(): 
            if 'RSDFactor' in line: 
                rsdfac = float(line.split()[-2])
